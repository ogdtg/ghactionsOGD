...
The package is using internally R functions imported directly from other R packages. The following R functions have been integrated as utilities functions:

- **[tic](https://github.com/ropensci/tic)**: `gha_add_secret()`
- **[ghactions](https://github.com/maxheld83/ghactions)**: `job()`, `step()`, `workflow()`
